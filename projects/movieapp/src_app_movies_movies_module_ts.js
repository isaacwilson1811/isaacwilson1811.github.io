(self["webpackChunkmovieApp"] = self["webpackChunkmovieApp"] || []).push([["src_app_movies_movies_module_ts"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PosterSize": () => (/* binding */ PosterSize)
/* harmony export */ });
var PosterSize;
(function (PosterSize) {
    PosterSize[PosterSize["XX_SML"] = 0] = "XX_SML";
    PosterSize[PosterSize["X_SML"] = 1] = "X_SML";
    PosterSize[PosterSize["SML"] = 2] = "SML";
    PosterSize[PosterSize["MED"] = 3] = "MED";
    PosterSize[PosterSize["LRG"] = 4] = "LRG";
    PosterSize[PosterSize["X_LRG"] = 5] = "X_LRG";
    PosterSize[PosterSize["ORIGINAL"] = 6] = "ORIGINAL";
...
/***/ 5050:
/*!***********************************************************!*\
  !*** ./src/app/movies/movie-card/movie-card.component.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _raw_loader_movie_card_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./movie-card.component.html */ 3124);
/* harmony import */ var _movie_card_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./movie-card.component.scss */ 2409);
...
/* harmony import */ var _models_enums__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/enums */ 7818);
...
let MovieCardComponent = class MovieCardComponent {
    constructor(router, api, storageService) {
        this.router = router;
        this.api = api;
    ...
    ngOnInit() {
        ...
        if (this.id) {
            this.api.getImages(this.id).subscribe((images) => {
                if (images['posters'].length) {
                    const path = images.posters[0].file_path;
                    this.imgUrl = `${this.config['images'].secure_base_url}/${this.config['images'].poster_sizes[_models_enums__WEBPACK_IMPORTED_MODULE_3__.PosterSize.SML]}${path}`;
                }
                else {
...
MovieCardComponent.ctorParameters = () => [
    ...
    { type: _services_api_service__WEBPACK_IMPORTED_MODULE_2__.MovieService },
    { type: _app_global_services_session_storage_service__WEBPACK_IMPORTED_MODULE_4__.SessionStorageService }
];
MovieCardComponent.propDecorators = {
    ...
    release: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__.Input }],
    popularity: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__.Input }]
};
MovieCardComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
/***/ 2843:
/*!************************************************************!*\
  !*** ./src/app/movies/movie-details/movie-details.page.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 4762);
/* harmony import */ var _raw_loader_movie_details_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./movie-details.page.html */ 9824);
/* harmony import */ var _movie_details_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./movie-details.page.scss */ 8930);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/core */ 7716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ 9895);
/* harmony import */ var _services_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/api.service */ 4423);
/* harmony import */ var _models_enums__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/enums */ 7818);
/* harmony import */ var _app_global_services_session_storage_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../app-global-services/session-storage.service */ 5982);
/* harmony import */ var src_app_app_global_services_firebase_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/app-global-services/firebase.service */ 2169);
...
let MovieDetailsPage = class MovieDetailsPage {
    constructor(activatedRoute, api, storageService, firebaseService) {
    ...
    getImage(id) {
        this.api.getImages(id).subscribe((images) => {
            if (images['posters'].length) {
                const path = images.posters[0].file_path;
                this.imgUrl = `${this.config['images'].secure_base_url}/${this.config['images'].poster_sizes[_models_enums__WEBPACK_IMPORTED_MODULE_3__.PosterSize.MED]}${path}`;
            }
            else {
                this.imgUrl = '../../assets/no_image.jpeg';
            }
...
MovieDetailsPage.ctorParameters = () => [
    ...
    { type: _services_api_service__WEBPACK_IMPORTED_MODULE_2__.MovieService },
    { type: _app_global_services_session_storage_service__WEBPACK_IMPORTED_MODULE_4__.SessionStorageService },
    { type: src_app_app_global_services_firebase_service__WEBPACK_IMPORTED_MODULE_5__.FirebaseService }
];
MovieDetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
/* harmony import */ var _movies_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./movies.page */ 7508);
/* harmony import */ var _movie_details_movie_details_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./movie-details/movie-details.page */ 2843);
...
const routes = [
    {
        path: '',
        component: _movies_page__WEBPACK_IMPORTED_MODULE_0__.MoviesPage
    },
    {
        path: 'details/:id',
        component: _movie_details_movie_details_page__WEBPACK_IMPORTED_MODULE_1__.MovieDetailsPage
    }
];
let MoviesRoutingModule = class MoviesRoutingModule {
};
MoviesRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/* harmony import */ var _services_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/api.service */ 4423);
/* harmony import */ var _movies_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./movies.page */ 7508);
/* harmony import */ var _movie_details_movie_details_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./movie-details/movie-details.page */ 2843);
/* harmony import */ var _movie_card_movie_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./movie-card/movie-card.component */ 5050);
...
MoviesModule = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.NgModule)({
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_11__.RouterModule.forChild([
                { path: '', component: _movies_page__WEBPACK_IMPORTED_MODULE_2__.MoviesPage },
                { path: 'details/:id', component: _movie_details_movie_details_page__WEBPACK_IMPORTED_MODULE_3__.MovieDetailsPage }
            ])
        ],
        declarations: [
            _movies_page__WEBPACK_IMPORTED_MODULE_2__.MoviesPage,
            _movie_details_movie_details_page__WEBPACK_IMPORTED_MODULE_3__.MovieDetailsPage,
            _movie_card_movie_card_component__WEBPACK_IMPORTED_MODULE_4__.MovieCardComponent
        ],
        providers: [
            _services_api_service__WEBPACK_IMPORTED_MODULE_1__.MovieService
        ]
    })
], MoviesModule);
...
/* harmony import */ var _raw_loader_movies_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./movies.page.html */ 5688);
/* harmony import */ var _movies_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./movies.page.scss */ 3145);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 7716);
/* harmony import */ var _services_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/api.service */ 4423);
...
let MoviesPage = class MoviesPage {
    ...
    getInitialMovies() {
        this.api.fetchMovies().subscribe((result) => {
            this.movieList = result.results;
        }, (error) => {
            console.error(error);
        });
        this.api.getConfig().subscribe((result) => {
            this.config = result;
        }, (error) => {
            console.error(error);
        });
    ...
    search() {
        if (this.queryText != '') {
            this.api.getSearchQuery(this.queryText).subscribe((results) => {
...
MoviesPage = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
let MovieService = class MovieService {
    constructor(http) {
        this.http = http;
        this.API_KEY = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.movieAPIKey;
    }
    fetchMovies() {
    ...
    getImages(id) {
        return this.http.get(`https://api.themoviedb.org/3/movie/${id}/images?api_key=${this.API_KEY}`);
    }
    getSearchQuery(query) {
        console.log(query);
        const reformattedQuery = query.replace(' ', '+');
        return this.http.get(`https://api.themoviedb.org/3/search/movie?api_key=${this.API_KEY}&query=${reformattedQuery}`);
    }
};
MovieService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
MovieService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/***/ 2409:
/*!*************************************************************!*\
  !*** ./src/app/movies/movie-card/movie-card.component.scss ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (".thumbnailImg {\n  width: 230px;\n  height: -webkit-fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ 8930:
/*!**************************************************************!*\
  !*** ./src/app/movies/movie-details/movie-details.page.scss ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (".center {\n  margin-left: auto;\n  margin-right: auto;\n  display: block !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/***/ 3124:
/*!***************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/movies/movie-card/movie-card.component.html ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-card-content class=\"no-padding\">\n  <ion-grid class=\"no-padding\">\n    <ion-row responsive-sm>\n      <ion-col width-35 class=\"no-padding\">\n        <img class=\"thumbnailImg\" src=\"{{ imgUrl }}\" alt=\"\">\n      </ion-col>\n      <ion-col>\n\n        <ion-list>\n          <ion-item text-wrap lines=\"none\">\n            <h2><strong>{{ title }}</strong></h2>\n          </ion-item>\n\n          <ion-item lines=\"none\">\n              <ion-icon name=\"calendar-outline\"></ion-icon>&nbsp;{{ release | date: 'y' }}\n          </ion-item>\n\n          <ion-item lines=\"none\">\n            <ion-icon name=\"thumbs-up-outline\"></ion-icon>&nbsp;{{ popularity| number: '1.0-0' }}%\n          </ion-item>\n\n          <ion-item lines=\"none\">\n            <ion-button *ngIf=\"isLoggedIn; else notLoggedIn\" color=\"warning\" shape=\"round\" (click)=\"goToDetails(id)\">Details</ion-button>\n            <ng-template #notLoggedIn>\n              <ion-button color=\"warning\" shape=\"round\" (click)=\"goToDetailsNotLoggedIn(id)\">Details</ion-button>\n            </ng-template>\n          </ion-item>\n        </ion-list>\n\n      </ion-col>\n    </ion-row>\n  </ion-grid>   \n</ion-card-content>");

/***/ }),

/***/ 9824:
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/movies/movie-details/movie-details.page.html ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-buttons slot=\"start\"><ion-back-button defaultHref=\"tabs/movies\"></ion-back-button></ion-buttons>\n    <ion-title style=\"text-align: center\">Movie Details</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<!-- <ion-header collapse=\"condense\">\n  <ion-toolbar>\n    <ion-buttons slot=\"start\"><ion-back-button defaultHref=\"tabs/movies\"></ion-back-button></ion-buttons>\n    <ion-title size=\"large\">Movie Details</ion-title>\n  </ion-toolbar>\n</ion-header> -->\n<!-- Page Content Below -->\n\n  \n<ion-content padding>\n  \n    <ion-card *ngIf=\"movieDetails\">\n      <ion-card-header>\n        <ion-card-title style=\"text-align: center\">\n          {{movieDetails.title}}\n        </ion-card-title>\n      </ion-card-header>\n\n      <ion-card-content style=\"text-align: center\" >\n        <img  src=\"{{ imgUrl }}\" alt=\"\">\n\n        <ion-item align-item=\"center\" lines=\"none\">\n          <ion-icon name=\"calendar-clear\" slot=\"start\"></ion-icon>\n          <ion-label>&nbsp;{{movieDetails.release_date | date: 'MMMM d, y' }}</ion-label>\n        </ion-item>\n\n        <ion-item lines=\"none\">\n          <ion-icon name=\"hourglass-outline\" slot=\"start\"></ion-icon>\n          <ion-label>&nbsp;{{movieDetails.runtime}} mins</ion-label>\n        </ion-item>\n        \n        <ion-item lines=\"none\">\n          <ion-icon name=\"film\" slot=\"start\"></ion-icon>\n          <ion-label text-wrap>&nbsp;{{movieDetails.overview}}</ion-label>\n        </ion-item>\n    \n\n        <ion-item lines=\"none\">\n          <ion-button class=\"center\" color=\"warning\" shape=\"round\" href=\"{{'https://www.imdb.com/title/' + movieDetails.imdb_id}}\" target=\"_blank\">IMDB</ion-button>\n          <ion-button class=\"center\" color=\"warning\" shape=\"round\" *ngIf=\"isLoggedIn && !isFound\" (click)=\"addMovie( movieDetails.id, movieDetails)\">Add to My List</ion-button>\n\n          <!-- <ion-icon class=\"like-heart\" [color]=\"liked ? 'danger' : ''\" (click)=\"like()\" name=\"heart\" slot= \"end\"></ion-icon> -->\n        </ion-item>\n  \n      </ion-card-content>\n        \n    <!-- <pre>{{movieDetails | json}}</pre> -->\n  \n  <!-- End Page Content -->\n  </ion-card>\n</ion-content>  ");

/***/ }),

/***/ 5688:
/*!*******************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/movies/movies.page.html ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<!-- Header -->\n<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <!-- <ion-buttons slot=\"start\">\n      <ion-back-button (click)=\"onClickBackButton()\" defaultHref=\"tabs/movies\"></ion-back-button>\n    </ion-buttons> -->\n    <ion-title style=\"text-align: center;\">{{pageTitle}}</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<!-- iOS Header -->\n<!-- <ion-header collapse=\"condense\">\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-back-button (click)=\"onClickBackButton()\" defaultHref=\"tabs/movies\"></ion-back-button>\n    </ion-buttons>\n    <ion-title size=\"large\">{{pageTitle}}</ion-title>\n  </ion-toolbar>\n</ion-header> -->\n\n<!-- Search Bar -->\n<ion-searchbar placeholder=\"Gone with the Wind, Tom Cruise, Hayao Miyazaki, ...\"\n  [(ngModel)]=\"queryText\"\n  (ionChange)=\"search()\"\n  debounce=1000>\n</ion-searchbar>\n\n<!-- Page Content Below -->\n<ion-content padding class=\"movieList-content\">\n\n    <div *ngIf=\"movieList\">\n      <ion-card  *ngFor=\"let movie of movieList\">\n        <app-movie-card\n          [config]=\"config\"\n          [title]=\"movie.title\"\n          [id]=\"movie.id\"\n          [release]=\"movie.release_date\"\n          [popularity]=\"movie.popularity\">\n        </app-movie-card>\n      </ion-card>\n    </div>\n\n</ion-content>\n<!-- End Page Content -->");
